    ...
    return (
        <CustomModalWithForm
            ...
            initialValues={{
                ...
                vendorDiscount: data?.vendorDiscount ? parseFloat(data?.vendorDiscount) : 0,
            ...
            {({ setFieldValue, values }) => (
                <Flex vertical className="w-full">
                    <Form layout="vertical">
                        ...
                        <TextInput
                            name="vendorDiscount"
                            label="Vendor Discount Contribution"
                            showToolTip
                            tooltipText="Vendor Discount Contribution Included in total discount"
                            type="text"
                            placeholder="Please enter vendor discount"
                            classes="rounded-sm"
                            maxLength={8}
                            allowTwoDecimalsOnly
                        />
