            ...
            {screens.md ? (
                <Row className="mt-5" gutter={14}>
                    ...
                    <Col xl={7} sm={24} className="w-full mt-4">
                        <Flex
                            vertical
                            className=" xl:mt-0 mt-5 border border-gray-200 p-6  rounded-xl"
                        >
                              <ShowTimer/>
                        ...
                        <div data-testid="continue">
                            <Button
                                danger
                                type="primary"
                                className="w-full font-medium px-5 h-11 mt-5"
                ...
                <>
                    ...
                    <Row className="mt-5" gutter={16}>
                        ...
                        <Col sm={24} className="w-full">
                            <Flex
                                vertical
                                className=" md:mt-0 mt-5 border border-gray-200 p-6  rounded-xl"
                            >
                                <Title level={5}>Total Amount</Title>
                                <Flex vertical className=" mt-4" gap={15}>
                                    <CheckoutTextRow
