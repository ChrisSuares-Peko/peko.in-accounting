...
const PDFViewer = ({
    ...
    const handlePageDrop = (e: React.DragEvent<HTMLDivElement>, pageIndex: number) => {
        ...
        const isOverlapping = (excludeId?: string) =>
    ...
    return (
        <Flex
            className="rounded-[18px] border border-[#E5E7EB] overflow-hidden h-[400px] md:h-[760px]"
            style={{ width: '100%' }}
        >
            {showPageSelector && (
                <Flex
                    vertical
                    className="hidden md:flex bg-white border-r border-[#E5E7EB] shrink-0 pt-8 py-3 px-2"
            ...
            <Flex vertical className="flex-1 min-w-0">
                {(fileName || showFileName) && (
                    <Flex
                        ...
                        className="px-4 pt-6 pb-4 border-b border-[#E5E7EB] bg-white shrink-0 items-center"
                    >
                        ...
                        {onFileRemove && (
                            <CloseCircleOutlined
                                className="text-[#EF4444] cursor-pointer text-md mr-1"
                            ...
                            {pages.map((img, i) => {
                                ...
                                return (
                                    <Flex
                                        ...
                                        onDrop={e =>
                                            handlePageDrop(e as React.DragEvent<HTMLDivElement>, pi)
                                        }
                                        onDragOver={e =>
                                            handlePageDragOver(
