        ...
        >
            <Flex vertical align="center" className="py-3">
                {isNameMismatchWarning && (
                    <>
                        <Result className="p-0 -mt-3 md:w-3/6" status="warning" />
                            ...
                            >
                                {pair.map((item, idx) => (
                                    <Flex vertical gap={7} key={idx}>
                                        ...
                                        <Typography.Text className="font-medium w-full break-words xs:w-64 sm:80 xl:w-96">
                                    ...
                                    <Flex vertical gap={7} key={idx}>
                                        ...
                                        {serviceKey === 'aadhar_ocr_verify' ? (
                                            <>
                                                {item.label === 'Ref.ID' ? (
                                                    ...
                                                    <a
                                                        ...
                                                        download
                                                        className="text-blue-800 w-96 break-words"
                                                    >
                                                        Masked Aadhaar
                                                    </a>
                                                )}
                                          ...
                                          (item.label === 'Photo' ||
                                            ...
                                            // Handling Aadhaar DigiLocker Verification photo/PDF
                                            <>
                                                {item.label === 'Photo' ? (
                                            ...
                                            <Typography.Text className="font-medium break-words xs:w-64 sm:80 xl:w-96">
