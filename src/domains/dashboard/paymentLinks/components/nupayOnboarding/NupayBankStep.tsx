            ...
            <Flex gap={20} wrap="wrap">
                ...
                <Form.Item
                    ...
                    rules={[
                        ...
                        { pattern: /^\d{9,18}$/, message: 'Account number must be 9 to 18 digits' },
                    ]}
                >
                    <Input placeholder="Enter Bank Account Number" maxLength={18} onChange={resetVerification} className="!h-11 !rounded-lg" />
                </Form.Item>
                <Form.Item
                    name="ifscCode"
                    label="IFSC Code"
