...
const NupayOnboardingFailed = ({ record, title = 'Payment Links' }: Props) => {
    ...
    return (
        <Flex align="center" justify="center" className="w-full px-3 py-6">
            <Card
                bordered={false}
                className="w-full max-w-[818px] rounded-[28px] shadow-[0px_2px_20px_0px_rgba(0,0,0,0.06)]"
            ...
            >
                <Flex vertical gap={30} align="center">
                    ...
                    <Flex vertical gap={20} className="w-full">
                        ...
                        {documents.length > 0 && (
                            <div className="w-full overflow-hidden rounded-lg shadow-[0px_2px_20px_0px_rgba(0,0,0,0.06)]">
