    ...
    return (
        <Flex vertical gap={16}>
            ...
            <Flex gap={10} wrap="wrap">
                <Card
                    bordered={false}
                    className="min-w-[220px] flex-1 rounded-xl overflow-hidden shadow-[0px_2px_20px_0px_rgba(0,0,0,0.06)]"
                ...
                <Card
                    bordered={false}
                    className="min-w-[220px] overflow-hidden flex-1 rounded-xl shadow-[0px_2px_20px_0px_rgba(0,0,0,0.06)]"
                    styles={{ body: { padding: '12px 16px', background: '#F9FBFF' } }}
                >
                    <Flex vertical gap={1}>
                        <Typography.Text className="text-[11px] leading-[1.35] text-[#98A2B3]">
            ...
            <Card
                bordered={false}
                className="rounded-xl overflow-hidden shadow-[0px_2px_20px_0px_rgba(0,0,0,0.06)]"
